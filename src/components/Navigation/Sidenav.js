    ...
    return (
      <nav className='side-nav-container side-nav '>
        ...
        <div className='side-nav-contents'>
          ...
          {
            SideNavItem(<svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='side-nav-contents'>
          <p className='side-nav-headings side-nav-item'>Payments</p>
          {
            SideNavItem(<svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg>, 'All Payments', 'svg')
          }
          {
            SideNavItem(<svg width="19" height="21" viewBox="0 0 19 21" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          }
          {
            ...
            , 'Un - Reconciled Payments', 'svg')
          }
          {
            SideNavItem(<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            , 'Manual Settlement', 'svg')
          }
          <div >
          </div>
        </div>
        <div className='side-nav-contents'>
          <p className='side-nav-headings side-nav-item'>Orders</p>
          {
            SideNavItem(<svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {
            SideNavItem(<svg width="21" height="18" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.18182 14.0909V1H16.2727V14.0909C16.2727 14.8624 15.9662 15.6024 15.4207 16.1479C14.8751 16.6935 14.1352 17 13.3636 17" stroke="#647787" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M10.4545 14.0909H1C1 14.8625 1.30649 15.6024 1.85205 16.1479C2.39761 16.6935 3.13755 17 3.90909 17H13.3636C12.5921 17 11.8522 16.6935 11.3066 16.1479C10.761 15.6024 10.4545 14.8625 10.4545 14.0909Z" stroke="#647787" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M9 7.54544H13.3636" stroke="#647787" stroke-miterlimit="10" stroke-linejoin="round"/>
            <path d="M6.09088 7.54544H7.54543" stroke="#647787" stroke-miterlimit="10" stroke-linejoin="round"/>
...
function SideNavItem(icon, child, type) {
  return (
    <>
